...
- [x] Nunito + Arabic companion font bundled
- [x] Signature components v1: CropCard, StreakFlame, XPBar, BigBouncyButton
- [x] Golden tests: each component × {light, dark} × {LTR, RTL}

## M0.3 — Localization
- [x] gen-l10n configured; `app_en.arb`, `app_ar.arb` ([[Localization]])
- [x] In-app language switcher (system/en/ar), persisted
- [x] RTL audit checklist added to PR template
