# Phase 5 — Screen Time (Android)

Spec: [[Screen-Time]]. The hardest platform work — scheduled late deliberately, once the habit loop is proven. iOS enforcement lands in Phase 6 alongside iOS polish.
