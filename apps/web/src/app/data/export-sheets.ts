...
export const SheetNames = {
  ...
  goals: 'Goals',
  goalItems: 'GoalItems',
  /** The lists themselves; their items are the Wishlist sheet, which kept its name ([[Lists]]). */
  lists: 'Lists',
  wishlist: 'Wishlist',
  expenses: 'Expenses',
...
export const sheetHeaders: Record<SheetKey, readonly string[]> = {
  ...
  goalItems: [
    ...
    'Position',
    'CommitmentUuid',
    // From v24 ([[Goals]] GL6): the task a subtask belongs to.
    'ParentUuid',
    'CreatedAt',
    'UpdatedAt',
    'DeletedAt',
  ],
  lists: ['Uuid', 'Name', 'Kind', 'Icon', 'Position', 'BuiltIn', 'CreatedAt', 'UpdatedAt', 'DeletedAt'],
  wishlist: [
    'Uuid',
    'List',
    'ListUuid',
