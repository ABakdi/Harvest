      ...
      >
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            className="absolute top-4 end-4 rounded-md p-1 opacity-70 transition-opacity hover:opacity-100 focus-visible:ring-2 focus-visible:ring-ring [&_svg]:size-4"
