...
void main() {
  ...
  test('the streak and XP come off the ledger, not a counter', () async {
    await db
        .into(db.streaks)
        .insert(
    ...
    expect(snapshot.xp, Xp.habitOrTodo);
  });
